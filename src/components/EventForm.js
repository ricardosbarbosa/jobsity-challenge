...
const EventForm = ({ initialValues = {}, onClickDelele = () => { }, onAddEvent = () => { }, onUpdateEvent = () => { }, onCancel = () => { }, props }) => {
  const handleDeleteClick = resetForm => () => {
    onClickDelele(initialValues.id) 
    resetForm({})
  }
  return (
    <div>
      ...
      >
        {({ values, errors, touched, resetForm, handleBlur, submitForm, isSubmitting, setFieldValue, isValid }) => (
          <Form >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              {initialValues.id && <Button variant="contained" color="secondary" disabled={isSubmitting} margin="normal" onClick={handleDeleteClick(resetForm)} >
                Delete
            </Button>}
            </div>
          </Form>
